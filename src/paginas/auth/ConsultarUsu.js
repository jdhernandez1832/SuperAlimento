                            ...
                            <div className="card-body table-responsive p-0">
                                <table  ref={tableRef1}className="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <td>John Doe</td>
                                        <td>Cedula</td>
                                        <td>john1563@hotmail.com</td>
                                        <td>3052433356</td>
                                        <td>hitler666</td>
                                        <td>Administrador</td>
                                        <td><Link to="/ActualizarUsu"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-pencil" viewBox="0 0 16 16">
