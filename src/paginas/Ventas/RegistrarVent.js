...
const RegistrarVent = () => {
    ...
    const navegacion = (event) => {
      ...
      navigate("/AgregarProd"); // Redirige al usuario al índice
    };
                ...
                <div className="card-body colorFondo">
                    <div className="card card-success">
                        <div className="card-header">
                            <h3 className="card-title">Registro de venta</h3>
                        </div>
                        <form onSubmit={navegacion} noValidate>
                            ...
                            <div className="card-footer">
                                ...
                                <button type="submit" className="btn btn-primary custom-button">Agregar productos</button>
                            </div>
                        </form>
                    </div>
                </div>
