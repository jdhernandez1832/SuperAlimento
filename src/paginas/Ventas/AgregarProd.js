                                ...
                                <table className="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>3000</td>
                                            <td>Granos</td>
                                            <td><Link to="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-pencil" viewBox="0 0 16 16">
            ...
            <div className="card-body colorFondo">
                <div className="row">
                    <div className="col-12">
                        <div className="card">
                            <div className="card-header">
                                <h3 className="card-title">Productos agregados: </h3>
                                <div className="card-tools">
                                </div>
                            </div>
                            <div className="card-body table-responsive p-0">
                            ...
                            <div className="card-header">
                                <h3 className="card-title">Total: 6000</h3>
                                <div className="card-tools">
                                </div>
                            </div>
                            <div className="card-header">
